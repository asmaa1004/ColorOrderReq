...
import '../models/cloths.dart' show Data, Cloths;
...
class _ColorOrderReqState extends State<ColorOrderReq> with DLL {
  ...
  void _getCloths() async {
    var response = await http
        .post(Uri.parse("$linkServerName/ColorOrderReq/RawStore.php"));

    setState(() {
      cloths = Cloths.fromJson(json.decode(response.body));
    });
  }
                    ...
                    children: [
                      Container(
                        ...
                        child: Autocomplete<Data>(
                          ...
                          displayStringForOption: (Data d) => d.cloth,
